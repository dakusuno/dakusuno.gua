...
import com.dakusuno.dakusunogua.databinding.ItemFollowingBinding
...
class FollowingViewHolder(view:View) : BaseViewHolder(view) {
    private lateinit var data: Item
    private val binding: ItemFollowingBinding by bindings(
        view
    )
